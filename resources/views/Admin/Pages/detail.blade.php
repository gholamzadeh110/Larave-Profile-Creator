    ...
    <div class="row">
        ...
        <div class="col-lg-6 col-md-12">
            <div class="card">
                <div class="blogitem mb-5">
                    <div class="blogitem-image">
                        <a href="#"><img src="{{asset('assets/images/image-gallery/1.jpg')}}" alt="blog image"></a>
                        <span class="blogitem-date">Monday, December 15, 2018</span>
                    </div>
                    <div class="blogitem-content">
                        <div class="blogitem-header">
                ...
                <div class="blogitem mb-5">
                    <div class="blogitem-image">
                        <a href="#"><img src="{{asset('assets/images/image-gallery/10.jpg')}}" alt="blog image"></a>
                        <span class="blogitem-date">Monday, December 15, 2018</span>
                    </div>
                    <div class="blogitem-content">
                        <div class="blogitem-header">
                ...
                <div class="blogitem mb-5">
                    <div class="blogitem-image">
                        <a href="#"><img src="{{asset('assets/images/image-gallery/2.jpg')}}" alt="blog image"></a>
                        <span class="blogitem-date">Monday, December 15, 2018</span>
                    </div>
                    <div class="blogitem-content">
                        <div class="blogitem-header">
